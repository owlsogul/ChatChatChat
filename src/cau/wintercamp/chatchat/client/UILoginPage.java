...
public class UILoginPage extends UIPage implements ActionListener{
	...
	public void getLoginDataFromClient(DataLogin data){
		if (data.getBool()){
		...
		signInButton.setText(strSignIn);
		canClickSignIn = true;
	}
	
	public void getRegisterDataFromClient(DataRegister data){
		if (data.getBool()){
			System.out.println("return true");
		}
		else {
		...
		signUpButton.setText(strSignUp);
		canClickSignUp = true;
	}
